...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        contentText.setOnClickListener(new TextView.OnClickListener(){
        ...
        if(note.getPriority().color == Color.WHITE)
        {
            itemView.setBackgroundResource(R.drawable.whitebutton_selector);
        }else if (note.getPriority().color == Color.RED)
        {
            itemView.setBackgroundResource(R.drawable.redbuton_selector);
        }else
        {
            itemView.setBackgroundResource(R.drawable.pinkbutton_selector);
        }
    }
}
